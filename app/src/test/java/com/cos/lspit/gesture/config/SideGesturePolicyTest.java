...
public class SideGesturePolicyTest {
    ...
    public void leftEdgeDownTouchFingerVetoes() {
        assertTrue(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 2f, 1300f, DISPLAY_W, DISPLAY_H));
    }

    @Test
    public void rightEdgeDownTouchFingerVetoes() {
        assertTrue(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 1078f, 1300f, DISPLAY_W, DISPLAY_H));
    }
    ...
    public void bottomStripDownIsNotVetoed() {
        ...
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 540f, 2372f, DISPLAY_W, DISPLAY_H));
    }

    @Test
    public void statusBarDownIsNotVetoed() {
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 2f, 50f, DISPLAY_W, DISPLAY_H));
    }
    ...
    public void nonTouchscreenSourceIsNotVetoed() {
        ...
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_STYLUS, TOOL_TYPE_FINGER, 2f, 1300f, DISPLAY_W, DISPLAY_H));
    }

    @Test
    public void nonFingerToolTypeIsNotVetoed() {
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_TOUCHSCREEN, 2, 2f, 1300f, DISPLAY_W, DISPLAY_H));
    }

    @Test
    public void actionMoveWithSideCoordsIsNotVetoed() {
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_MOVE, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 2f, 1300f, DISPLAY_W, DISPLAY_H));
    }

    @Test
    public void actionUpWithSideCoordsIsNotVetoed() {
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_UP, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 2f, 1300f, DISPLAY_W, DISPLAY_H));
    }

    @Test
    public void centerDownIsNotVetoed() {
        assertFalse(SideGesturePolicy.shouldVeto(
                ACTION_DOWN, SOURCE_TOUCHSCREEN, TOOL_TYPE_FINGER, 540f, 1300f, DISPLAY_W, DISPLAY_H));
    }
